...
| PHP 7.2 & 7.3<br>cli & fpm | ARN: [`arn:aws:lambda:<region>:209497400698:layer:php-73-fpm:<version>`](https://runtimes.bref.sh/)<br>Link:[`mnapoli/bref`](https://github.com/mnapoli/bref) | `provided` |
