...
| OpenCV | ARN: `arn:aws:lambda:us-east-1:939532784043:layer:opencv:2`<br>Link: [`harshthakur9030/opencv-lambda-layer-python3`](https://github.com/harshthakur9030/opencv-lambda-layer-python3) | python3.6, python3.7, python3.8 |
